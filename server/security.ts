...
export const validators = {
  ...
  speakerApplication: [
    ...
    body('selectedTopicIds').isArray({ min: 3, max: 3 }).withMessage('You must select exactly 3 speaking topics'),
    body('selectedTopicIds.*').isInt().withMessage('Topic IDs must be valid integers'),
