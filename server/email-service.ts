...
The SpeakerSphere Team`
  ...
  // Speaker notification for new inquiry (Pro/Premier tiers only)
  async sendInquirySpeakerNotification(inquiry: any, speakerEmail: string, speakerName: string): Promise<boolean> {
    const template: EmailTemplate = {
      to: speakerEmail,
      from: FROM_EMAIL,
      subject: `New Booking Inquiry from ${inquiry.clientName}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <h2 style="color: #2563eb;">You have a new booking inquiry!</h2>
          
          <p>Dear ${speakerName},</p>
          
          <p>Great news! You've received a new speaking engagement inquiry through SpeakerSphere.</p>
          
          <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="color: #475569; margin-top: 0;">Client Information</h3>
            <p><strong>Name:</strong> ${inquiry.clientName}</p>
            <p><strong>Company:</strong> ${inquiry.clientCompany}</p>
            <p><strong>Email:</strong> <a href="mailto:${inquiry.clientEmail}">${inquiry.clientEmail}</a></p>
          </div>
          
          <div style="background-color: #f0fdf4; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #22c55e;">
            <h3 style="color: #16a34a; margin-top: 0;">Event Details</h3>
          ...
          <div style="background-color: #fef9c3; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h4 style="color: #854d0e; margin-top: 0;">Client Message:</h4>
            <p style="color: #713f12; font-style: italic;">"${inquiry.message}"</p>
          </div>
          ...
          <div style="text-align: center; margin: 30px 0;">
            <p style="color: #475569; margin-bottom: 15px;">Reply directly to this email to respond to the client.</p>
          </div>
          
          <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 30px 0;">
          <p style="font-size: 12px; color: #94a3b8;">
            This inquiry was sent through your SpeakerSphere profile. You're receiving this because you have a Pro or Premier subscription that includes direct inquiry notifications.
          </p>
        </div>
      `,
      text: `You have a new booking inquiry!

Dear ${speakerName},

Great news! You've received a new speaking engagement inquiry through SpeakerSphere.
