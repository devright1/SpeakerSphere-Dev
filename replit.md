...
## Recent Changes
- **March 18, 2026**: Fixed "Link to Existing" button in admin application review — now triggers duplicate check API and includes speaker search box so admin can find any speaker to link; backend now properly sets speaker.userId and application.createdSpeakerId when linking; added Change Password feature to speaker dashboard Profile tab
