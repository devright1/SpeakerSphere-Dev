...
## Recent Changes
- **November 17, 2025**: Added DevRight branding to all 11 email templates with logo served from /api/devright-logo.png (public endpoint, cross-origin enabled, 1-year cache)
