  ...
  const steps = [
    {
      icon: Search,
      title: "Search & Filter",
      description: "Browse our verified speakers by category, expertise, location, and ratings. Use our advanced filters to find the perfect match for your event and see who the cool kids are!"
    },
    {
      icon: UserCheck,
