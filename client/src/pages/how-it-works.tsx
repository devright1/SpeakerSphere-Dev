  ...
  const steps = [
    {
      icon: Search,
      title: "Search & Filter",
      description: "Browse our verified speakers by discipline, expertise, location, and ratings. Use our advanced filters to find the perfect match for your event - no need to brush past the best options!"
    },
    {
      icon: UserCheck,
          ...
          <div className="bg-gray-50 rounded-2xl card-spacing mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 text-balance max-w-3xl mx-auto">
                The one and only platform for speaker bios, booking, reviews and engagment
              </p>
            </div>
